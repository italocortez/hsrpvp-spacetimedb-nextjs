...
export default function DiscordLink({ user }: DiscordLinkProps) {
    const { loginDiscord } = useAuthContext();
        ...
        return (
            <div className={styles.container}>
                <div className={styles.linked}>
                    ...
                    <span className={styles.linked_text}>Discord linked</span>
    ...
    return (
        <div className={styles.container}>
            <p className={styles.description}>
                Link your Discord account to verify your profile and unlock username changes.
            </p>
