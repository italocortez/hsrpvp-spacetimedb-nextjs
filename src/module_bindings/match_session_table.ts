...
export default __t.row({
  ...
  currentGameNumber: __t.u8().name("current_game_number"),
  gamesWonBlue: __t.u8().name("games_won_blue"),
  gamesWonRed: __t.u8().name("games_won_red"),
  seriesBestOf: __t.u8().name("series_best_of"),
