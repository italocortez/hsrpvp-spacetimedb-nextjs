      ...
      indexes: [
        {
          ...
          name: "hsr_character_cost_character_name_game_mode_draft_mode_cost_set_id_idx_btree",
          algorithm: "btree",
          columns: ["characterName", "gameMode", "draftMode", "costSetId"],
        },
        {
  ...
  HsrLightconeCost: __table(
    {
      ...
      indexes: [
        ...
        },
        {
          ...
          name: "hsr_lightcone_cost_lightcone_name_game_mode_draft_mode_cost_set_id_idx_btree",
          algorithm: "btree",
          columns: ["lightconeName", "gameMode", "draftMode", "costSetId"],
        },
      ],
      constraints: [],
    },
  ...
  HsrSynergyCost: __table(
    {
      ...
      indexes: [
        ...
        },
        {
          ...
          name: "hsr_synergy_cost_source_name_game_mode_draft_mode_idx_btree",
          algorithm: "btree",
          columns: ["sourceName", "gameMode", "draftMode"],
        },
        {
          accessor: "by_tuple",
          name: "hsr_synergy_cost_source_name_target_name_game_mode_draft_mode_cost_set_id_idx_btree",
          algorithm: "btree",
          columns: [
            "sourceName",
            "targetName",
  ...
  MatchSessionStep: __table(
    {
      ...
      indexes: [
        {
          accessor: "by_actor_user",
          name: "match_session_step_actor_user_id_idx_btree",
          algorithm: "btree",
          columns: ["actorUserId"],
        },
        {
