...
**Project skills:** @D:/GitsWork/hsrpvp-spacetimedb-nextjs/.claude/get-shit-done/references/project-skills-discovery.md
...
@D:/GitsWork/hsrpvp-spacetimedb-nextjs/.claude/get-shit-done/references/planner-source-audit.md for full format, examples, and gap-handling rules.
...
@D:/GitsWork/hsrpvp-spacetimedb-nextjs/.claude/get-shit-done/references/planner-source-audit.md for constraint examples.
...
**Test:** Could a different Claude instance execute without asking clarifying questions? If not, add specificity. See @D:/GitsWork/hsrpvp-spacetimedb-nextjs/.claude/get-shit-done/references/planner-antipatterns.md for vague-vs-specific comparison table.

## TDD Detection

**When `workflow.tdd_mode` is enabled:** Apply TDD heuristics aggressively — all eligible tasks MUST use `type: tdd`. Read @D:/GitsWork/hsrpvp-spacetimedb-nextjs/.claude/get-shit-done/references/tdd.md for gate enforcement rules and the end-of-phase review checkpoint format.
...
@D:/GitsWork/hsrpvp-spacetimedb-nextjs/.claude/get-shit-done/references/planner-antipatterns.md
...
```bash
node "D:/GitsWork/hsrpvp-spacetimedb-nextjs/.claude/get-shit-done/bin/gsd-tools.cjs" graphify status
```
...
```bash
node .claude/get-shit-done/bin/gsd-sdk.cjs query history-digest
```
...
@D:/GitsWork/hsrpvp-spacetimedb-nextjs/.claude/get-shit-done/references/thinking-models-planning.md
...
```bash
STRUCTURE=$(node .claude/get-shit-done/bin/gsd-sdk.cjs query verify.plan-structure "$PLAN_PATH")
```
...
```bash
node .claude/get-shit-done/bin/gsd-sdk.cjs query commit "docs($PHASE): create phase plan" \
...
See @D:/GitsWork/hsrpvp-spacetimedb-nextjs/.claude/get-shit-done/references/planner-chunked.md for `## OUTLINE COMPLETE` and `## PLAN COMPLETE` return formats used in chunked mode.
