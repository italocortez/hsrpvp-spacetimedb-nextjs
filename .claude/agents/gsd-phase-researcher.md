...
```bash
node .claude/get-shit-done/bin/gsd-sdk.cjs query websearch "your query" --limit 10
```
...
```bash
node .claude/get-shit-done/bin/gsd-sdk.cjs query commit "docs($PHASE): research phase domain" "$PHASE_DIR/$PADDED_PHASE-RESEARCH.md"
```
