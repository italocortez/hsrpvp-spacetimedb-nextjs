...
<required_reading>
@D:/GitsWork/hsrpvp-spacetimedb-nextjs/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@D:/GitsWork/hsrpvp-spacetimedb-nextjs/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = D:/GitsWork/hsrpvp-spacetimedb-nextjs/.claude
                  → checks D:/GitsWork/hsrpvp-spacetimedb-nextjs/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = D:/GitsWork/hsrpvp-spacetimedb-nextjs/.claude/get-shit-done
                  → writes to D:/GitsWork/hsrpvp-spacetimedb-nextjs/.claude/get-shit-done/hooks/
...
@D:/GitsWork/hsrpvp-spacetimedb-nextjs/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @D:/GitsWork/hsrpvp-spacetimedb-nextjs/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node .claude/get-shit-done/bin/gsd-sdk.cjs query state.load)
...
```bash
node .claude/get-shit-done/bin/gsd-sdk.cjs query commit "docs: resolve debug {slug}" .planning/debug/resolved/{slug}.md
```
...
```bash
node .claude/get-shit-done/bin/gsd-sdk.cjs query commit "docs: update debug knowledge base with {slug}" .planning/debug/knowledge-base.md
```
