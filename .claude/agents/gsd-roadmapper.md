...
Reference full template: `D:/GitsWork/hsrpvp-spacetimedb-nextjs/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/GitsWork/hsrpvp-spacetimedb-nextjs/.claude/get-shit-done/templates/state.md`.
