...
Use `node .claude/get-shit-done/bin/gsd-sdk.cjs query commit` with conventional format (message first, then every staged file path):
```bash
...
```bash
node .claude/get-shit-done/bin/gsd-sdk.cjs query commit "fix(02): CR-01 ..." \
