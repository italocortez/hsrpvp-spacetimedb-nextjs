...
**Using `node .claude/get-shit-done/bin/gsd-sdk.cjs query` (preferred):**

```bash
# Commit with automatic commit_docs + gitignore checks:
node .claude/get-shit-done/bin/gsd-sdk.cjs query commit "docs: update state" .planning/STATE.md
