...
```bash
node .claude/get-shit-done/bin/gsd-sdk.cjs query commit "docs: initialize [project-name] ([N] phases)" .planning/
```
...
```bash
node .claude/get-shit-done/bin/gsd-sdk.cjs query commit "docs({phase}-{plan}): complete [plan-name] plan" .planning/phases/XX-name/{phase}-{plan}-PLAN.md .planning/phases/XX-name/{phase}-{plan}-SUMMARY.md .planning/STATE.md .planning/ROADMAP.md
```
...
```bash
node .claude/get-shit-done/bin/gsd-sdk.cjs query commit "wip: [phase-name] paused at task [X]/[Y]" .planning/
```
...
```bash
node .claude/get-shit-done/bin/gsd-sdk.cjs query commit-to-subrepo "feat(02-01): add user API" \
