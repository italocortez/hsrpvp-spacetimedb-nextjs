...
- Usage: Reference from command with `@D:/GitsWork/hsrpvp-spacetimedb-nextjs/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to D:/GitsWork/hsrpvp-spacetimedb-nextjs/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to D:/GitsWork/hsrpvp-spacetimedb-nextjs/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
