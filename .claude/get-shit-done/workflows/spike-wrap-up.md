...
```bash
node .claude/get-shit-done/bin/gsd-sdk.cjs query commit "docs(spike-wrap-up): package [N] spike findings into project skill" .planning/spikes/WRAP-UP-SUMMARY.md
```
</step>
