...
AGENT_SKILLS=$(node .claude/get-shit-done/bin/gsd-sdk.cjs query agent-skills gsd-executor 2>/dev/null)
```
...
```bash
VERIFIER_SKILLS=$(node .claude/get-shit-done/bin/gsd-sdk.cjs query agent-skills gsd-verifier 2>/dev/null)
```
