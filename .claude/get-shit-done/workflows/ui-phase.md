...
AGENT_SKILLS_UI=$(node .claude/get-shit-done/bin/gsd-sdk.cjs query agent-skills gsd-ui-researcher)
AGENT_SKILLS_UI_CHECKER=$(node .claude/get-shit-done/bin/gsd-sdk.cjs query agent-skills gsd-ui-checker)
```
