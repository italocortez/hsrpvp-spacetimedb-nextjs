...
```bash
node .claude/get-shit-done/bin/gsd-sdk.cjs query init.progress
```
...
```bash
node .claude/get-shit-done/bin/gsd-sdk.cjs query commit "docs(v${VERSION}): generate milestone summary for onboarding" \
