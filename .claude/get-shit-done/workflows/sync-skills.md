...
INSTALL_JS_GLOBAL="D:/GitsWork/hsrpvp-spacetimedb-nextjs/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node D:/GitsWork/hsrpvp-spacetimedb-nextjs/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
