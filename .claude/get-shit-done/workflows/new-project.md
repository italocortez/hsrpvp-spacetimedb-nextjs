...
AGENT_SKILLS_RESEARCHER=$(node .claude/get-shit-done/bin/gsd-sdk.cjs query agent-skills gsd-project-researcher)
AGENT_SKILLS_SYNTHESIZER=$(node .claude/get-shit-done/bin/gsd-sdk.cjs query agent-skills gsd-research-synthesizer)
AGENT_SKILLS_ROADMAPPER=$(node .claude/get-shit-done/bin/gsd-sdk.cjs query agent-skills gsd-roadmapper)
```
