...
- **Global scope**: `D:/GitsWork/hsrpvp-spacetimedb-nextjs/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `D:/GitsWork/hsrpvp-spacetimedb-nextjs/.claude/notes/`)
...
2. Glob `D:/GitsWork/hsrpvp-spacetimedb-nextjs/.claude/notes/*.md` (if directory exists) — global notes
...
Global (D:/GitsWork/hsrpvp-spacetimedb-nextjs/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `D:/GitsWork/hsrpvp-spacetimedb-nextjs/.claude/notes/` — works in any directory
