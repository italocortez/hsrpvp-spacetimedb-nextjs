...
```bash
cp "D:/GitsWork/hsrpvp-spacetimedb-nextjs/.claude/get-shit-done/USER-PROFILE.md" "D:/GitsWork/hsrpvp-spacetimedb-nextjs/.claude/USER-PROFILE.backup.md"
```
...
```bash
BACKUP_PATH="D:/GitsWork/hsrpvp-spacetimedb-nextjs/.claude/USER-PROFILE.backup.md"
```
