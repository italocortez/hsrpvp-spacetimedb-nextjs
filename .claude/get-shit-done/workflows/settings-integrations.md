...
```bash
node .claude/get-shit-done/bin/gsd-sdk.cjs query config-ensure-section
...
```bash
BRAVE=$(node .claude/get-shit-done/bin/gsd-sdk.cjs query config-get brave_search --default null)
FIRECRAWL=$(node .claude/get-shit-done/bin/gsd-sdk.cjs query config-get firecrawl --default null)
EXA=$(node .claude/get-shit-done/bin/gsd-sdk.cjs query config-get exa_search --default null)
SEARCH_GITIGNORED=$(node .claude/get-shit-done/bin/gsd-sdk.cjs query config-get search_gitignored --default false)
```
...
```bash
node .claude/get-shit-done/bin/gsd-sdk.cjs query config-set brave_search "<value>"     # masked in output
node .claude/get-shit-done/bin/gsd-sdk.cjs query config-set firecrawl "<value>"        # masked in output
node .claude/get-shit-done/bin/gsd-sdk.cjs query config-set exa_search "<value>"       # masked in output
node .claude/get-shit-done/bin/gsd-sdk.cjs query config-set search_gitignored true|false
```

For "Clear", write `null`:

```bash
node .claude/get-shit-done/bin/gsd-sdk.cjs query config-set brave_search null
```
</step>
...
```bash
node .claude/get-shit-done/bin/gsd-sdk.cjs query config-set review.models.<cli> "<command string>"
```
...
```bash
node .claude/get-shit-done/bin/gsd-sdk.cjs query config-set agent_skills.<slug> "<skill-a,skill-b,skill-c>"
```
