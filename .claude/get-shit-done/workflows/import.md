...
```bash
node .claude/get-shit-done/bin/gsd-sdk.cjs query commit "docs({phase}): import plan from {basename FILEPATH}" .planning/phases/{phase}/{plan}-PLAN.md .planning/ROADMAP.md
```
