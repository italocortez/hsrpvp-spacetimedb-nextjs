...
OLLAMA_HOST=$(node .claude/get-shit-done/bin/gsd-sdk.cjs query config-get review.ollama_host 2>/dev/null | jq -r '.' 2>/dev/null || echo "")
...
LM_STUDIO_HOST=$(node .claude/get-shit-done/bin/gsd-sdk.cjs query config-get review.lm_studio_host 2>/dev/null | jq -r '.' 2>/dev/null || echo "")
...
LLAMA_CPP_HOST=$(node .claude/get-shit-done/bin/gsd-sdk.cjs query config-get review.llama_cpp_host 2>/dev/null | jq -r '.' 2>/dev/null || echo "")
...
OPENCODE_MODEL=$(node .claude/get-shit-done/bin/gsd-sdk.cjs query config-get review.models.opencode 2>/dev/null | jq -r '.' 2>/dev/null || true)
```
...
OLLAMA_HOST=$(node .claude/get-shit-done/bin/gsd-sdk.cjs query config-get review.ollama_host 2>/dev/null | jq -r '.' 2>/dev/null || echo "")
if [ -z "$OLLAMA_HOST" ] || [ "$OLLAMA_HOST" = "null" ]; then OLLAMA_HOST="http://localhost:11434"; fi
OLLAMA_MODEL=$(node .claude/get-shit-done/bin/gsd-sdk.cjs query config-get review.models.ollama 2>/dev/null | jq -r '.' 2>/dev/null || echo "")
...
LM_STUDIO_HOST=$(node .claude/get-shit-done/bin/gsd-sdk.cjs query config-get review.lm_studio_host 2>/dev/null | jq -r '.' 2>/dev/null || echo "")
if [ -z "$LM_STUDIO_HOST" ] || [ "$LM_STUDIO_HOST" = "null" ]; then LM_STUDIO_HOST="http://localhost:1234"; fi
LM_STUDIO_MODEL=$(node .claude/get-shit-done/bin/gsd-sdk.cjs query config-get review.models.lm_studio 2>/dev/null | jq -r '.' 2>/dev/null || echo "")
...
LLAMA_CPP_HOST=$(node .claude/get-shit-done/bin/gsd-sdk.cjs query config-get review.llama_cpp_host 2>/dev/null | jq -r '.' 2>/dev/null || echo "")
if [ -z "$LLAMA_CPP_HOST" ] || [ "$LLAMA_CPP_HOST" = "null" ]; then LLAMA_CPP_HOST="http://localhost:8080"; fi
LLAMA_CPP_MODEL=$(node .claude/get-shit-done/bin/gsd-sdk.cjs query config-get review.models.llama_cpp 2>/dev/null | jq -r '.' 2>/dev/null || echo "")
...
Commit:
```bash
node .claude/get-shit-done/bin/gsd-sdk.cjs query commit "docs: cross-AI review for phase {N}" {phase_dir}/{padded_phase}-REVIEWS.md
```
</step>
