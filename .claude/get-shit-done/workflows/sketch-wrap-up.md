...
```bash
node .claude/get-shit-done/bin/gsd-sdk.cjs query commit "docs(sketch-wrap-up): package [N] sketch findings into project skill" .planning/sketches/WRAP-UP-SUMMARY.md
```
</step>
