...
```bash
node .claude/get-shit-done/bin/gsd-sdk.cjs query commit "docs(spike-NNN): [VERDICT] — [key finding in one sentence]" .planning/spikes/NNN-descriptive-name/ .planning/spikes/MANIFEST.md
```
