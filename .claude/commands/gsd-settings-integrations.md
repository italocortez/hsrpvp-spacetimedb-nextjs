...
<execution_context>
@D:/GitsWork/hsrpvp-spacetimedb-nextjs/.claude/get-shit-done/workflows/settings-integrations.md
</execution_context>
...
6. Writing values via `node .claude/get-shit-done/bin/gsd-sdk.cjs query config-set` (which merges, preserving
   unrelated keys)
