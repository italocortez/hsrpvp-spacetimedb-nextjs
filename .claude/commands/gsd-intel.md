...
Intel system is disabled. To activate:
  ...
  node .claude/get-shit-done/bin/gsd-sdk.cjs query config-set intel.enabled true
...
```bash
node .claude/get-shit-done/bin/gsd-sdk.cjs query intel.query <term>
```
...
```bash
node .claude/get-shit-done/bin/gsd-sdk.cjs query intel.status
```
...
```bash
node .claude/get-shit-done/bin/gsd-sdk.cjs query intel.diff
```
...
4. Use `node .claude/get-shit-done/bin/gsd-sdk.cjs query intel.extract-exports <file>` to analyze source files
5. Use `node .claude/get-shit-done/bin/gsd-sdk.cjs query intel.patch-meta <file>` to update timestamps after writing
6. Use `node .claude/get-shit-done/bin/gsd-sdk.cjs query intel.validate` to check your output
