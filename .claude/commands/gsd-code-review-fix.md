...
<execution_context>
@D:/GitsWork/hsrpvp-spacetimedb-nextjs/.claude/get-shit-done/workflows/code-review-fix.md
</execution_context>
...
Context files (CLAUDE.md, REVIEW.md, phase state) are resolved inside the workflow via `node .claude/get-shit-done/bin/gsd-sdk.cjs query init.phase-op` and delegated to agent via config blocks.
</context>

<process>
This command is a thin dispatch layer. It parses arguments and delegates to the workflow.

Execute the code-review-fix workflow from @D:/GitsWork/hsrpvp-spacetimedb-nextjs/.claude/get-shit-done/workflows/code-review-fix.md end-to-end.
