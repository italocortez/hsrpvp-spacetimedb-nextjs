...
<execution_context>
@D:/GitsWork/hsrpvp-spacetimedb-nextjs/.claude/get-shit-done/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @D:/GitsWork/hsrpvp-spacetimedb-nextjs/.claude/get-shit-done/workflows/session-report.md end-to-end.
</process>
