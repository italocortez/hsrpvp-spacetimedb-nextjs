...
| `set_coach` | refereeManagement.ts | Lobby Host or Referee | Set participationRole=Coach on a lobby member |
| `remove_coach` | refereeManagement.ts | Lobby Host or Referee | Set participationRole=Player on a lobby member |
